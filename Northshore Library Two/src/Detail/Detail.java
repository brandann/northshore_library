...
public class Detail {
    ...
    public Detail(String in)
    {
        ...
        company = inString[1].toUpperCase();
        jobName = inString[2].toUpperCase();
        jobNumber = inString[3].toUpperCase();
        searchable = inString[4].toUpperCase();
        addedDate = inString[5].toUpperCase();
        Description = inString[6].toUpperCase();
        pdf = inString[7].toUpperCase();
        dwg = inString[8].toUpperCase();
        jpg = inString[9].toUpperCase();
        tags = inString[10].toUpperCase();
    }
